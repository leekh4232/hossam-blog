...
date: 2025-03-54 14:48:03
author: Hossam
image: /images/index-java3.jpg
...
#### 양의 정수 1부터 n까지의 총 합을 구하는 기능을 재귀함수로 구현하시오.

n부터 1씩 감소하면서 합산을 하고 1이 되는 순간 더 이상 진행하지 않고 종료해야 한다.

예를 들어 n이 5일 때, `5 + 4 + 3 + 2 + 1`이 되어야 한다.
...
<p align="center"><img src="/images/2025/0323/f.png" width="60%"></p>
