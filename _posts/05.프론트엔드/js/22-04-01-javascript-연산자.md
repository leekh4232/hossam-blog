...
연산자는 변수를 활용하여 각종 연산을 수행하는데 사용되는 특수 기호 입니다.
...
1. 연산 결과를 변수 스스로에게 덮어 씌우기
    - 어떤 변수 $x$에 대한 연산 결과를 다시 $x$에 덮어 씌울 수 있다.
...
<img src="/images/2022/0401/pipe.png" width="150" />
