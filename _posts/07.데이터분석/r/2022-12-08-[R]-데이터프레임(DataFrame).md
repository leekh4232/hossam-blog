...
description: "데이터프레임(DataFrame)은 **행과 열로 구성된 사각형의 표 형식의 자료구조**로서 데이터 분석에서 가장 유용하며 필수불가결한 자료형입니다. 데이터프레임이라는 용어가 낯설다면 엑셀과 같은 분석 프로그램의 시트(sheet) 데이터를 구현하기 위한 자료형이라고 생각하면 이해하기 쉽습니다."
date:   2022-12-08
author: Hossam
...
<img src="/images/2022/1208/df0.png" width="300" />
...
<img src="/images/2022/1208/df1.png" width="280" />
...
<img src="/images/2022/1208/df2.png" width="320" />
...
[https://data.hossam.kr/r/grade.txt](https://data.hossam.kr/r/grade.txt)
...
```r
성적표txt <- read.table("https://data.hossam.kr/r/grade.txt",
...
<img src="/images/2022/1208/df3.png" width="480" />
...
```r
성적표txt <- read.table("https://data.hossam.kr/r/grade.txt",
                 sep='\t', header=TRUE, na.strings="", fileEncoding="utf-8")
성적표txt
```
...
<img src="/images/2022/1208/df4.png" width="480" />
...
성적표csv <- read.csv("https://data.hossam.kr/r/grade.csv",
...
<img src="/images/2022/1208/df5.png" width="480" />
...
# 엑셀 파일 다운로드 받기
download.file("https://data.hossam.kr/r/grade.xlsx", filename, mode='wb')
...
<img src="/images/2022/1208/df6.png" width="480" />