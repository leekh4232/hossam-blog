...
description: Github에서 다른 계정의 저장소를 내 계정으로 복사하는 것을 Fork라고 합니다. Fork를 하게 되면 원본 저장소의 변경사항이 자동으로 반영되지 않습니다. 원본 저장소와의 동기화를 위해서는 아래와 같은 과정을 거쳐야 합니다.
categories: [컴퓨터활용, Git]
